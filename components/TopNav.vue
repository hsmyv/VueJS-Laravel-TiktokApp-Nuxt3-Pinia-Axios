     ...
     <div 
        ...
        >
            ...
            >
                ...
                <div class="hidden md:flex items-center bg-white p-1 rounded-full max-w-[380px] w-full">
                    <input type="text"
                ...
                <div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
                    ...
                    <div v-if="!$userStore.id" class="flex items-center">
                        <button @click="$generalStore.isLoginOpen = true" class="flex items-center bg-[#F02C56] text-white border rounded-md px-3 py-[6px]">
                    ...
                    <div v-else class="flex items-center">
                        <Icon name="carbon:send-alt" class="ml-1 mr-4" color="#161724" size="30"/>
